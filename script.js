...
for (var i = 0; i < arrStudenti.length; i ++){
    var nomeStudente = null;
    var cognomeStudente = null;
    var elementoRicerca = arrStudenti[i];
    if(elementoRicerca.nome){
        nomeStudente = elementoRicerca;
    }
    if(elementoRicerca.cognome)
    cognomeStudente = elementoRicerca;    
}
